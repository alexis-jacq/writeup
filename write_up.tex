...
During the first year of my \textit{Ph.D.} I worked to develop the CoWriter activity by improving the 
...
vision-based head pose estimator), to on-line computation of with-me-ness. The process can be described in 3 main steps:
...
We validated this approach using a naturalistic setup involving children during a complex robot-teaching task.
